...
export default function SferRouter() {
	return (
		<div className="container mt-3">
			<Switch>
				<Route path="/sfer/home" > <HomeRole /> </Route>
				<Route path="/sfer/center" > <Center /> </Route>

                                <Route path="/sfer/prods" > <Prods /> </Route>
				<Route path="/sfer/prod/:id" > <Prod /> </Route>

				<Route path="/sfer/orders" > <Orders /> </Route>

				<Route path="/sfer/pds" > <Pds /> </Route>
				<Route path="/sfer/pd/:id" > <Pd /> </Route>

				<Route path="/sfer/setting" > <Setting /> </Route>

				<Route path="/sfer/reload" > <Reload/> </Route>
